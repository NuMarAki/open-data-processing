...
from processamento.processador_base import ProcessadorSeguro
from analises.analise_etarismo import AnalisadorEtarismo
...
def processar_base(tipo: str) -> Optional[str]:
    ...
    processadores = {
        'pnad': (ProcessadorPNAD, 'config/pnad.cfg'),
        'rais': (ProcessadorRAIS, 'config/rais.cfg'),
        'caged': (ProcessadorCAGED, 'config/caged.cfg')
    }
